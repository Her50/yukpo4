#!/bin/bash
# Script pour désactiver les auto-migrations dans ECS
# Usage: ./desactiver_auto_migrations_ecs.sh
...
echo "🔧 Désactivation des auto-migrations dans ECS..."
...
# 4. Modifier la task definition pour mettre ENABLE_AUTO_MIGRATIONS=false
