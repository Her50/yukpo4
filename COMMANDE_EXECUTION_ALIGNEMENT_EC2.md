# 🚀 Commande Directe - Alignement Tables EC2

## Commande à Copier-Coller sur EC2
...
Vous devriez voir :
- Des messages `NOTICE` pour chaque colonne ajoutée
- Un tableau de vérification montrant toutes les colonnes présentes
