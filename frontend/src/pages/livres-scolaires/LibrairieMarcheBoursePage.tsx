                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="text-left text-gray-500 border-b border-gray-100">
                      ...
                      <th className="py-2 pr-2">Statut troc</th>
                      <th className="py-2 pr-2 text-right">Valeur</th>
                      <th className="py-2 pr-2">Dispo</th>
                    </tr>
                  </thead>
                  <tbody>
                    {filteredRecent.length === 0 ? (
                      ...
                      filteredRecent.map((b) => (
                        <tr key={b.id} className="border-b border-gray-50">
                          <td className="py-2 pr-2 font-medium text-gray-800">{b.titre}</td>
                          <td className="py-2 pr-2 text-gray-600">{b.classe_actuelle ?? '—'}</td>
