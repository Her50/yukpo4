// ✅ Page de recherche d'agences de voyage (Frontend)
        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-4xl mx-auto px-4">
                <h1 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                    ...
                    Rechercher une agence de voyage
                </h1>
                ...
                <Card className="mb-6">
                    ...
                    <CardContent>
                        <form onSubmit={handleSearch} className="space-y-6">
                            ...
                            {/* Destination */}
                            <div>
                                <Label htmlFor="destination">Destination recherchée (optionnel)</Label>
                                <Input
                                    id="destination"
                                    value={destination}
                            ...
                            {/* Compagnie bus */}
                            <div>
                                <Label htmlFor="compagnieBus">Compagnie de bus (optionnel)</Label>
                                <Input
                                    id="compagnieBus"
                                    value={compagnieBus}
                                    onChange={(e) => setCompagnieBus(e.target.value)}
