...
// Fonction utilitaire pour extraire la valeur d'un champ de service - VERSION CORRIGÃ‰E
const getServiceFieldValue = (field: any): string => {
  ...
  // Cas 2: Objet complexe (nouveaux services) - STRUCTURE CORRIGÃ‰E
  if (field && typeof field === 'object') {
    // VÃ©rifier si c'est un objet avec la structure {valeur, type_donnee, origine_champs}
    ...
    // VÃ©rifier si c'est un objet avec d'autres propriÃ©tÃ©s
    if (Object.keys(field).length > 0) {
      // Essayer de trouver une valeur dans les propriÃ©tÃ©s communes
...
// Fonction utilitaire pour dÃ©boguer les champs de contact d'un service
const debugServiceContacts = (service: any) => {
  console.log('ðŸ” [DEBUG] Structure complÃ¨te du service:', service);
  console.log('ðŸ” [DEBUG] Service.data:', service.data);
  
  if (service.data) {
    console.log('ðŸ” [DEBUG] Champs de contact dans service.data:');
    ...
    console.log('ðŸ” [DEBUG] Test getServiceFieldValue:');
    ...
    return R * c;
        ...
        const getFlagEmoji = (countryCode: string): string => {
          ...
          const knownFlags: { [key: string]: string } = {
            ...
            'UM': 'ðŸ‡ºðŸ‡²', 'AX': 'ðŸ‡¦ðŸ‡½', 'FO': 'ðŸ‡«ðŸ‡´', 'GL': 'ðŸ‡¬ðŸ‡±', 'GI': 'ðŸ‡¬ðŸ‡®', 'JE': 'ðŸ‡¯ðŸ‡ª', 'IM': 'ðŸ‡®ðŸ‡²', 'GG': 'ðŸ‡¬ðŸ‡¬'
          };
                      ...
                      {(!getServiceFieldValue(service.data?.telephone) || getServiceFieldValue(service.data?.telephone) === 'Non spÃ©cifiÃ©') &&
                       ...
                       (!getServiceFieldValue(service.data?.website) || getServiceFieldValue(service.data?.website) === 'Non spÃ©cifiÃ©') && (
                        <div className="col-span-2 p-3 bg-gray-50 border border-gray-200 rounded-xl text-center">
                          <p className="text-sm text-gray-500">Aucun contact supplÃ©mentaire disponible</p>
