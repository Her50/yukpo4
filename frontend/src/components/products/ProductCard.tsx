...
const ProductCard: React.FC<ProductCardProps> = ({
    ...
    const getTypeStyle = () => {
        const styles = {
            ...
            electromenager: { icon: '📱', color: 'bg-cyan-50 text-cyan-700 border-cyan-200', label: 'Électro' },
            mobilier: { icon: '🪑', color: 'bg-lime-50 text-lime-700 border-lime-200', label: 'Mobilier' },
