...
Write-Host "Génération d'un nouveau token JWT" -ForegroundColor Green
...
try {
    ...
    Write-Host "Token: $new_token" -ForegroundColor Gray
    
    # Test avec le nouveau token
    Write-Host "`n2. Test de la recherche avec le nouveau token..." -ForegroundColor Cyan
