#!/usr/bin/env python3
"""
Test de la fonction de recherche restaurée du 17 juillet
"""
...
# Configuration
BACKEND_URL = "http://localhost:3001"  # Port du backend Rust

def test_recherche_restauree():
    print("🧪 TEST DE LA FONCTION DE RECHERCHE RESTAURÉE DU 17 JUILLET")
    print("=" * 60)
