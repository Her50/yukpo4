...
**Hypothèse** : Il y a peut-être une fonction SQL ou une vue qui utilise `e` comme alias pour `global_promo_events`, ou la vue matérialisée `global_promo_catalog_cache` doit être rafraîchie.
