# ❓ Réponses Directes - Questions ML
...
- Prêt pour ajouter des modèles ONNX plus tard
- Le répertoire est déjà créé et documenté
...
**Dans le code** (`DeliveryAIETAService::predict_eta_with_ai`):
...
**Donc**: IA externe = **Enrichissement**, ML = **Calcul principal**
...
| Composant | Rôle | Priorité | Fallback Si Échoue |
|-----------|------|----------|-------------------|
| **IA Externe (Prompts)** | Enrichissement contexte | 1 | Valeurs par défaut |
| **ML Formules** | Calcul numérique | 2 (toujours) | - |
| **ML ONNX** | Calcul amélioré | 3 (optionnel) | Formules optimisées |
