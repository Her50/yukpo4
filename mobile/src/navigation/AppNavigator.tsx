...
import HotelMeubleBookingScreen from '../screens/specialized/HotelMeubleBookingScreen';
import HotelMeubleFormScreen from '../screens/specialized/HotelMeubleFormScreen';
import HotelReservationQRScreen from '../screens/specialized/HotelReservationQRScreen';
...
import ImmobilierBulkFormScreen from '../screens/specialized/ImmobilierBulkFormScreen';
import HotelAvailabilityManagementScreen from '../screens/specialized/HotelAvailabilityManagementScreen';
import MyFavoritesScreen from '../screens/specialized/MyFavoritesScreen';
import SearchAlertsScreen from '../screens/specialized/SearchAlertsScreen';
...
const ImmobilierBulkFormScreenWithSafeArea = withNavigatorSafeArea(ImmobilierBulkFormScreen);
...
const HotelAvailabilityManagementScreenWithSafeArea = withNavigatorSafeArea(HotelAvailabilityManagementScreen);
const HotelMeubleFormScreenWithSafeArea = withNavigatorSafeArea(HotelMeubleFormScreen);
const HotelReservationQRScreenWithSafeArea = withNavigatorSafeArea(HotelReservationQRScreen);
...
const SearchAlertsScreenWithSafeArea = withNavigatorSafeArea(SearchAlertsScreen);
  ...
  React.useEffect(() => {
    if (user?.role === 'partenaire' && user.partner_type) {
      const partnerTypeToScreen: Record<string, string> = {
        ...
        // ✅ NOUVEAU 2026-01-27: Écrans dédiés pour hôtels et meublés
        'hotel': 'HotelMeubleForm',
        'meuble': 'HotelMeubleForm',
        'hôtel': 'HotelMeubleForm',
        'meublé': 'HotelMeubleForm',
        'residence': 'HotelMeubleForm',
        'auberge': 'HotelMeubleForm',
      ...
      console.log('[AppNavigator] 🏢 Partenaire détecté:', user.partner_type, '→', targetScreen);
      
      // Redirection après un court délai pour s'assurer que le navigator est prêt
      const timer = setTimeout(() => {
        try {
          (navigation as any).navigate(targetScreen as never);
          console.log('[AppNavigator] ✅ Redirection vers', targetScreen);
        } catch (error) {
          console.error('[AppNavigator] ❌ Erreur redirection:', error);
        }
      }, 500);
  ...
  return (
    ...
    >
      ...
      />
        ...
        <Stack.Screen name="ImmobilierBulkForm" component={ImmobilierBulkFormScreenWithSafeArea} />
        <Stack.Screen name="ImmobilierBooking" component={ImmobilierBookingScreenWithSafeArea} />
        <Stack.Screen name="HotelMeubleBooking" component={HotelMeubleBookingScreenWithSafeArea} />
        <Stack.Screen name="HotelBookingPayment" component={HotelBookingPaymentScreenWithSafeArea} />
        <Stack.Screen name="HotelAvailabilityManagement" component={HotelAvailabilityManagementScreenWithSafeArea} />
        <Stack.Screen name="HotelMeubleForm" component={HotelMeubleFormScreenWithSafeArea} />
        ...
        <Stack.Screen 
          name="SearchAlerts" 
          component={SearchAlertsScreenWithSafeArea}
          options={{
            ...defaultScreenOptions,
...
const AuthenticatedApp = () => {
  ...
  console.log('[AppNavigator] ✅ Providers chargés: Theme + Language + Location');
  return (
    <ThemeProvider>
      <LanguageProvider>
        <LocationProvider>
