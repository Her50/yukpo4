        ...
        <View style={styles.content}>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoText}>
              <Text style={styles.infoTitle}>G�rez vos services</Text>
              <Text style={styles.infoDescription}>
                Cr�ez et g�rez vos services pour attirer plus de clients
              </Text>
            </View>
          </View>
          ...
          >
            ...
            <Text style={styles.createButtonText}>Cr�er un nouveau service</Text>
          </TouchableOpacity>
