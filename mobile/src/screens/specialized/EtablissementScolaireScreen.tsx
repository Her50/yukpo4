// Collecte de programmes scolaires : établissements du primaire au secondaire, tous pays.
// L'établissement envoie ses programmes sous forme d'images (caméra / galerie) ou fichier joint,
// et précise son nom + localisation GPS s'il n'est pas encore enregistré sur la plateforme.
...
const EtablissementScolaireScreen: React.FC = () => {
    ...
    const handleSubmit = useCallback(async () => {
        ...
        if (files.length === 0) {
            Alert.alert('Fichier requis', t('etablissementScolaire.fileRequired', 'Veuillez joindre au moins une image ou un fichier du programme scolaire.'));
            return;
        }
            ...
            <SafeNativeView style={styles.container}>
                <View style={styles.successContainer}>
                    ...
                    <Text style={styles.successTitle}>
                        {t('etablissementScolaire.successTitle', 'Programme envoyé !')}
                    </Text>
                    <Text style={styles.successText}>
                        {t('etablissementScolaire.successText', 'Merci ! Votre programme scolaire a été soumis avec succès. Il sera traité et ajouté à la base de données de la bourse du livre.')}
                    </Text>
                    <TouchableOpacity
                    ...
                    >
                        ...
                        <Text style={styles.successButtonText}>
                            {t('etablissementScolaire.sendAnother', 'Envoyer un autre programme')}
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
            ...
            <LinearGradient colors={['#059669', '#10B981', '#34D399']} style={styles.header}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.headerSubtitle}>
                        {t('etablissementScolaire.subtitle', 'Envoyez vos programmes scolaires')}
                    </Text>
                </View>
                ...
                >
                    ...
                    <View style={styles.infoBanner}>
                        ...
                        <Text style={styles.infoBannerText}>
                            {t('etablissementScolaire.infoBanner', 'Photographiez ou joignez la liste officielle des manuels de votre établissement. Cela aide les parents à trouver les bons livres.')}
                        </Text>
                    </View>
                    ...
                    {/* Pièces jointes */}
                    <Text style={styles.label}>
                        {t('etablissementScolaire.fichiersLabel', 'Programme scolaire (images ou fichiers)')} *
                    </Text>
                        ...
                        {submitting ? (
                            ...
                            <>
                                ...
                                <Text style={styles.submitButtonText}>
                                    {t('etablissementScolaire.submit', 'Envoyer le programme')}
                                </Text>
                            </>
                        )}
                    </TouchableOpacity>
