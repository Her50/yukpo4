// ✅ Écran de recherche de banques de sang (Mobile)
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Rechercher une banque de sang</Text>
            </View>
            ...
            <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
                <View style={styles.searchForm}>
                    ...
                    {/* Groupe sanguin */}
                    <View style={styles.inputGroup}>
                        <Text style={styles.label}>Groupe sanguin recherché (optionnel)</Text>
                        <View style={styles.bloodGroupContainer}>
                            <TouchableOpacity
                                style={[styles.bloodGroupButton, !groupeSanguin && styles.bloodGroupButtonActive]}
                                onPress={() => setGroupeSanguin('')}
                            >
                            ...
                            {groupesSanguins.map((groupe) => (
                                <TouchableOpacity
                                    ...
                                    onPress={() => setGroupeSanguin(groupeSanguin === groupe ? '' : groupe)}
                                >
