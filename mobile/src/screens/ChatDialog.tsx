    ...
    return (
      ...
      >
        <View style={`max-w-xs lg:max-w-md ${isOwn ? 'order-2' : 'order-1'}`}>
          ...
          <View style={`rounded-lg px-3 py-2 ${
            isOwn 
            ...
            <p style="text-sm">{msg.content}</Text>
            
            <View style={`flex items-center justify-between mt-1 ${
        ...
        <View style="bg-white border-b px-4 py-3 flex items-center justify-between">
          <View style="flex items-center">
            ...
            <View style="flex items-center">
              ...
              />
              <View>
                <h2 style="font-semibold">{prestataireInfo?.name || 'Prestataire'}</h2>
                <View style="flex items-center text-sm text-gray-500">
                  <View style={`w-2 h-2 rounded-full mr-1 ${
        ...
        <View style="bg-white border-t p-4">
          <View style="flex items-center space-x-2">
            ...
            <View style="flex-1 relative">
              ...
              <TouchableOpacity
                ...
                variant="outline"
                size="sm"
                style={`absolute right-2 top-1/2 transform -translate-y-1/2 ${
          ...
          {showEmojiPicker && (
            <View style="mt-2 p-2 bg-gray-100 rounded">
              <p style="text-sm text-gray-600">Emoji picker à implémenter</Text>
            </View>
          )}
        </View>
