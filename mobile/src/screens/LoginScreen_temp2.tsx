    ...
    try {
      ...
      if (res.ok) {
        ...
        window.dispatchEvent(new CustomEvent('tokens_updated'));
          ...
          login(data.token);
          navigation.navigate(ROUTES.HOME); // Redirige vers l'accueil aprÃ¨s connexion
  ...
  return (
    <main style="min-h-screen pt-28 bg-gradient-to-br from-yellow-50 via-white to-red-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <View style="max-w-md mx-auto bg-white dark:bg-gray-900 shadow-xl rounded-xl p-8">
        ...
        {/*
        {import.meta.env.DEV && (
          <View style="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-200 dark:border-blue-800">
            <p style="text-sm text-blue-800 dark:text-blue-200 font-medium mb-2">
              ðŸ§ª Mode dÃ©veloppement - Identifiants de test :
            </Text>
            <p style="text-xs text-blue-700 dark:text-blue-300">
