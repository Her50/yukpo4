    ...
    <AppLayout>
      <section style="min-h-screen py-16 px-6 bg-gradient-to-tr from-white via-yellow-50 to-pink-50 dark:from-gray-900 dark:to-gray-950 font-sans">
        <View style="max-w-3xl mx-auto bg-white dark:bg-gray-900 shadow-xl rounded-xl p-8 space-y-6">
          <Text style="text-3xl font-extrabold text-center text-gray-800 dark:text-white flex items-center justify-center gap-2">
            🧭 Mon Espace Personnel
          </Text>

          <View style="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
            <Text style="text-xl font-bold mb-4 text-gray-700 dark:text-gray-200">
            ...
            <ul style="space-y-4">
              {recent.map((item) => (
                ...
                >
                  <View>
                    <Text style="font-medium text-gray-800 dark:text-gray-100">
                      {item.label}
                    </Text>
