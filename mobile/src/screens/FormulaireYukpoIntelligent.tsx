    ...
    <AppLayout>
      ...
      <View style="container mx-auto px-4 py-8">
        ...
        {showSuccessToast && successData && (
          <View style="fixed top-4 right-4 bg-green-500 text-white p-6 rounded-lg shadow-xl z-50 max-w-md">
            <View style="flex items-start gap-3">
              <View style="flex-shrink-0">
                <View style="w-8 h-8 bg-green-400 rounded-full flex items-center justify-center">
                  <Text style="text-green-800 text-xl">✅</Text>
                </View>
              </View>
              <View style="flex-1">
                ...
                <View style="flex gap-2">
                  <TouchableOpacity
                    ...
                    style="flex-1 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-sm font-medium transition-colors"
                  >
                    🏠 Retour à l'accueil
                  </TouchableOpacity>
                  <TouchableOpacity
                    ...
                    style="flex-1 bg-green-700 hover:bg-green-800 text-white px-4 py-2 rounded text-sm font-medium transition-colors"
                  >
                    📋 Mes Services
                  </TouchableOpacity>
                </View>
