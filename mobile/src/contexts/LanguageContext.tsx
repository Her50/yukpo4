...
const translations: { [lang: string]: { [key: string]: string } } = {
    fr: {
        ...
        'video.intro.heroDescription': 'Modèles professionnels, images générées par IA, musique et voix off — tout inclus.',
        'video.intro.benefit.timeline': 'Montage vidéo vertical (9:16) optimisé pour les réseaux sociaux',
        'video.intro.benefit.broll': 'Images et transitions cinématographiques créées automatiquement par l\'IA',
        'video.intro.benefit.audio': 'Musique de fond et effets sonores professionnels inclus',
        ...
        'videoWizard.alert.renderDoneTitle': 'Vidéo prête !',
        'videoWizard.alert.renderDoneMessage': 'Ta vidéo a été créée avec succès.',
        'videoWizard.alert.renderFailedTitle': 'Création impossible',
        'videoWizard.alert.renderFailedMessage': 'Un problème est survenu. Veuillez réessayer.',
        'videoWizard.hero.title': 'Studio vidéo immersif Yukpo',
        'videoWizard.hero.subtitle': 'Crée des vidéos professionnelles en quelques clics : scénario intelligent, musique, voix off et effets cinéma inclus.',
        ...
        'videoWizard.sections.describe': 'Décris ta vidéo',
        'videoWizard.sections.style': 'Style visuel',
        'videoWizard.sections.audio': 'Musique & voix',
        'videoWizard.sections.media': 'Médias sélectionnés',
        'videoWizard.sections.timeline': 'Montage par scène',
        'videoWizard.sections.epilogue': 'Aperçu et publication',
        ...
        'videoWizard.steps.assets': 'Choisis tes visuels',
        'videoWizard.steps.preview': 'Aperçu et génération',
        'videoWizard.placeholders.brief': 'Décris ce que tu veux montrer dans ta vidéo. Ex : Promo de rentrée, 50% sur la formule premium',
        'videoWizard.placeholders.headline': 'Titre principal de ta vidéo (optionnel)',
        'videoWizard.placeholders.cta': 'Texte du bouton d\'action. Ex : Commandez maintenant (optionnel)',
        'videoWizard.placeholders.voiceLang': 'Langue (fr, en...)',
        'videoWizard.controls.storyboard': 'Scénario automatique',
        'videoWizard.controls.storyboardHint': 'Yukpo crée automatiquement les scènes de ta vidéo.',
        ...
        'videoWizard.buttons.nextStep': 'Continuer',
        'videoWizard.buttons.prevStep': 'Retour étape {{step}}',
        'videoWizard.buttons.previewTimeline': 'Voir un aperçu',
        'videoWizard.buttons.estimating': 'Estimation...',
        'videoWizard.buttons.rendering': 'Création en cours...',
        'videoWizard.buttons.launchRender': 'Créer ma vidéo',
        ...
        'videoWizard.summary.noCost': 'Passe d’abord à l\'étape suivante pour voir l\'aperçu.',
        'videoWizard.summary.finalConfirm': 'Tout est prêt ! Lance la création ?',
        'videoWizard.summary.finalHint': 'La création prend entre 30 secondes et 2 minutes.',
        ...
        'videoWizard.progress.title': 'Création de ta vidéo',
        ...
        'videoWizard.progress.jobIdle': 'Lance la création pour suivre l\'avancement.',
        ...
        'videoWizard.modal.title': 'Création en cours',
        'videoWizard.modal.subtitle': 'Ta vidéo est en cours de création ✨',
    ...
    en: {
        ...
        'video.intro.heroDescription': 'Professional templates, AI-generated visuals, music and voiceover — all included.',
        'video.intro.benefit.timeline': 'Vertical video (9:16) optimized for social media',
        'video.intro.benefit.broll': 'Cinematic images and transitions created automatically by AI',
        'video.intro.benefit.audio': 'Professional background music and sound effects included',
        ...
        'videoWizard.sections.timeline': 'Scene editing',
