...
const MES_SERVICES_TAB_CONFIG: {
  ...
  actions: [
    ...
    { id: 'ms-publicite', label: 'Gérer mes publicités', icon: LUCIDE_ICONS.eye, route: 'PubliciteDashboard', category: 'navigation', description: 'Campagnes pub' },
    { id: 'ms-new-ad', label: 'Créer une publicité', icon: LUCIDE_ICONS.add, route: 'CreatePublicite', category: 'creation', description: 'Création pub' },
    ...
    { id: 'ms-live', label: 'Lancer un live', icon: LUCIDE_ICONS.video, route: 'StartLive', category: 'creation', description: 'Live streaming' },
    ...
    { id: 'ms-share', label: 'Partager ma fiche', icon: LUCIDE_ICONS.share, category: 'action', description: 'Share natif lien yukpomnang.com/service/{id}' },
