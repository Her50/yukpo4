/**
 * BulkActionsBar - Barre d'actions group├®es (inspir├® Amazon/Gmail)
 * Permet s├®lection multiple et actions en masse
 */
                ...
                <View style={styles.actions}>
                    {actions.map((action) => (
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                // Passer les IDs s├®lectionn├®s depuis le parent
                                // Note: Les IDs seront r├®cup├®r├®s depuis selectedItems dans le parent
                                action.onPress([]);
                            }}
                            activeOpacity={0.7}
                        >
