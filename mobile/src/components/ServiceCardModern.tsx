...
// Ô£à Extraire les URLs de m├®dia de mani├¿re robuste (string, {valeur:...}, array)
...
interface ServiceCardModernProps {
    ...
    // Ô£à NOUVEAU: Support s├®lection multiple (Bulk Actions)
    bulkMode?: boolean;
    selected?: boolean;
...
const ServiceCardModern: React.FC<ServiceCardModernProps> = ({
    ...
    return (
        ...
        >
            {/* Ô£à NOUVEAU: Checkbox de s├®lection en mode bulk */}
            {bulkMode && (
            ...
            {/* Ô£à NOUVEAU 2026-03-03: Thumbnail du service */}
            {(() => {
                // Chercher la premi├¿re image disponible: logo ÔåÆ banner ÔåÆ images ÔåÆ premier produit
                ...
                // Trouver la premi├¿re image (pas vid├®o)
            ...
            <View style={styles.serviceInfo}>
                ...
                {service.interactions !== undefined && service.interactions != null && (
                    <View style={styles.infoRow}>
                        <Text style={styles.infoText}>­ƒôè {String(service.interactions || 0)} interactions</Text>
                    </View>
                )}
                {/* Nombre de produits - Cliquable comme statistique */}
                {(() => {
                    // Ô£à CORRECTION: V├®rifier et s├®curiser l'acc├¿s aux produits
            ...
            {/* Actions - Design am├®lior├® avec labels */}
            <View style={styles.actionsContainer}>
                ...
                {/* Ô£à Seconde rang├®e d'actions - Bouton vid├®o d├®plac├® dans le menu global */}
                <View style={styles.actionsRow}>
                    {/* Promouvoir (publicit├®) - Retir├® car maintenant dans le menu global */}
