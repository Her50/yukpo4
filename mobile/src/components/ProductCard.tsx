...
const ProductCard: React.FC<ProductCardProps> = ({
    ...
    const getTypeStyle = () => {
        const styles = {
            ...
            electromenager: { icon: 'smartphone', color: '#06B6D4', bg: '#CFFAFE', label: 'Électro' },
            mobilier: { icon: 'box', color: '#84CC16', bg: '#ECFCCB', label: 'Mobilier' },
            aliments: { icon: 'pizza', color: '#F59E0B', bg: '#FEF3C7', label: 'Aliment' },
