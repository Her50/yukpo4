...
const TUTORIAL_STEPS: TutorialStep[] = [
    {
        id: 'welcome',
        title: 'Bienvenue dans la creation video',
        description: 'Creez des videos promotionnelles en quelques etapes.',
        icon: 'sparkles',
    },
    {
        id: 'select-product',
        title: 'Selectionnez votre produit',
        description: 'Choisissez le produit ou service a promouvoir.',
        icon: 'package',
    },
    {
        id: 'brief',
        title: 'Redigez votre brief',
        description: 'Decrivez votre message cle et votre cible.',
        icon: 'edit',
    },
    {
        id: 'media',
        title: 'Ajoutez vos medias',
        description: 'Selectionnez les images et videos a utiliser.',
        icon: 'image',
    },
    {
        id: 'style',
        title: 'Personnalisez le style',
        description: 'Choisissez le style visuel et la tonalite.',
        icon: 'palette',
    },
    {
        id: 'generate',
        title: 'Generez votre video',
        description: 'Lancez la generation et suivez le resultat.',
        icon: 'play-circle',
    },
];
