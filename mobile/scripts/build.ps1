# Script de build temporaire pour résoudre l'erreur de linter
# Ce fichier peut être supprimé après résolution du cache
...
Write-Host "🚀 Build temporaire - Plateforme: $Platform, Profil: $Profile" -ForegroundColor Green
...
function Start-Build {
    ...
    try {
        npx eas build --platform $platform --profile $buildProfile --non-interactive
