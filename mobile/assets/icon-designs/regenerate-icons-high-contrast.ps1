# Script pour regenerer les icones avec CONTRASTE MAXIMAL (Y visible)
Write-Host "Regeneration des icones Yukpo (VERSION HAUTE CONTRASTE)..." -ForegroundColor Yellow
Write-Host "   Le Y sera maintenant PARFAITEMENT VISIBLE!" -ForegroundColor Cyan
Write-Host ""
...
# Utiliser le fichier SVG haute contraste
$svgFile = "yukpo-icon-high-contrast.svg"
...
Write-Host "Utilisation de : $svgFile (version haute contraste)" -ForegroundColor Green
Write-Host ""
...
Write-Host "   - Fond bleu PLUS CLAIR pour meilleur contraste" -ForegroundColor White
Write-Host "   - Y orange/jaune PLUS VIF et PLUS EPAIS" -ForegroundColor White
Write-Host "   - Contour blanc PLUS EPAIS (10px) pour visibilite maximale" -ForegroundColor White
Write-Host "   - Ombre PLUS PRONONCEE pour profondeur" -ForegroundColor White
Write-Host ""
