# Recalcul des Tableaux avec Logique 1 Commerçant = 1 Produit Actif

## Logique de Calcul

**Hypothèse minimale : 1 commerçant = 1 produit actif**

## Tableau 2026 (6 mois) - Production Juillet-Décembre
...
**Moyenne mensuelle produits actifs** : 10,500 / 6 = **1,750 produits**
...
## Rentabilité sur 5 Ans (Ajustée)

| Année | Revenus | Charges | Résultat | Marge |
|-------|---------|---------|----------|-------|
| 2026 (6m) | 69M | 350M | **-281M** | -407% |
| 2027 | 155M | 1,450M | **-1,295M** | -835% |
| 2028 | 358M | 3,800M | **-3,442M** | -961% |
| 2029 | 980M | 14,500M | **-13,520M** | -1,380% |
| 2030 | 2,190M | 42,000M | **-39,810M** | -1,816% |

**Note** : Les charges sont trop élevées par rapport aux revenus. Il faut soit :
1. Réduire les charges
2. Augmenter les revenus (plus de commerçants ou plus de produits par commerçant)
3. Ajuster le modèle économique

## Amélioration CSS pour Éviter Coupures de Pages
