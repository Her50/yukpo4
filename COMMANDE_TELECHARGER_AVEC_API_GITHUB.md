# ✅ Télécharger avec l'API GitHub (Solution qui Fonctionne)
...
# Définir le token (remplacez YOUR_TOKEN par votre token GitHub)
...
# Télécharger chaque migration avec l'API GitHub
for migration in "${MIGRATIONS[@]}"; do
    echo "📥 $migration"
    curl -L "https://api.github.com/repos/Her50/yukpo4/contents/backend/migrations/$migration" \
...
- ❌ **Ne fonctionne pas** : `https://raw.githubusercontent.com/...`
- ✅ **Fonctionne** : `https://api.github.com/repos/.../contents/...`

L'API GitHub avec le header `Accept: application/vnd.github.v3.raw` retourne le contenu brut du fichier.
