# Test de recherche en anglais
Write-Host "Test de recherche en anglais..." -ForegroundColor Green
...
try {
    ...
    Write-Host "Recherche 'car': $($response.results.Count) résultats" -ForegroundColor Green
