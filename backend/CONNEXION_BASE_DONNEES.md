...
- **Host (Serveur):** `your-render-db-host.render.com`
...
- **Password (Mot de passe):** `YOUR_PASSWORD`
...
```bash
psql -h your-render-db-host.render.com -U yukpo_db_user -d yukpo_db
```
Quand demandé, entrez le mot de passe: `YOUR_PASSWORD`

### Méthode 3: Via pgAdmin ou DBeaver (Interface graphique)
1. **Type:** PostgreSQL
2. **Host:** `your-render-db-host.render.com`
3. **Port:** `5432`
