...
DROP FUNCTION IF EXISTS calculate_vector_match_score_optimized(TEXT[], TEXT[]) CASCADE;
DROP FUNCTION IF EXISTS calculate_vector_match_score_optimized(vector_normalized TEXT[], search_keywords_normalized TEXT[]) CASCADE;
