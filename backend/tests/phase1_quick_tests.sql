-- ============================================
-- TESTS RAPIDES PHASE 1 : Table Products
-- ============================================
-- Script simplifié pour vérification rapide
-- Date: 2026-01-03
-- ============================================

-- TEST 1 : Vérifier intégrité produits (CRITIQUE)
...
-- TEST 2 : Vérifier product_id dans autocomplete_characteristics (CRITIQUE)
...
-- TEST 4 : Vérifier services récents (nouveaux produits sans JSONB)
