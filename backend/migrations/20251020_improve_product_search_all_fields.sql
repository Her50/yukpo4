...
-- 2. Index GIN sur le texte extrait de tous les produits
...
-- 3. Fonction améliorée de scoring produits qui cherche dans TOUS les champs
...
-- 4. Vue matérialisée pour cache de recherche produits (optionnel, pour performance)
