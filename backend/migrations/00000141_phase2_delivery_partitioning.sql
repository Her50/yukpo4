...
-- ============================================================================
-- 4. TABLE D'ARCHIVE POUR LIVRAISONS COMPLÉTÉES (protégée)
-- ============================================================================
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'deliveries_archive') THEN
        WITH archived AS (
...
DECLARE
    ...
    is_partitioned BOOLEAN;
BEGIN
    -- Protection: Vérifier que la table deliveries existe et est partitionnée
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'deliveries') THEN
        RAISE NOTICE 'Table deliveries n''existe pas';
        RETURN;
    END IF;
    ...
    IF NOT is_partitioned THEN
        RAISE NOTICE 'Table deliveries n''est pas partitionnée';
        RETURN;
    END IF;
