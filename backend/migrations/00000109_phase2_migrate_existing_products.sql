...
-- echo (commenté car commande psql, pas SQL) '🚀 Début Phase 2 : Migration des produits existants...'

-- ============================================
-- ÉTAPE 1 : Migrer les produits depuis JSONB vers service_products
-- ============================================
-- echo (commenté car commande psql, pas SQL) '📦 Étape 1 : Migration des produits depuis JSONB...'
...
-- ============================================
-- echo (commenté car commande psql, pas SQL) '🔧 Étape 2 : Correction des product_id dans autocomplete_characteristics...'
...
-- ============================================
-- echo (commenté car commande psql, pas SQL) '✅ Étape 3 : Vérification post-migration...'
...
-- echo (commenté car commande psql, pas SQL) '✅ Phase 2 terminée !'
