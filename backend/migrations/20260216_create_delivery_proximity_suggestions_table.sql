-- Migration: Créer la table delivery_proximity_suggestions
-- Date: 2026-02-16
-- Problème: La table delivery_proximity_suggestions n'existe pas et cause des erreurs dans les logs
-- Solution: Créer la table avec la structure correcte
