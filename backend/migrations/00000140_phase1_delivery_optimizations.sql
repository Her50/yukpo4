...
-- ============================================================================
-- 1. INDEX PARTIELS POUR LIVRAISONS ACTIVES (protégé)
-- ============================================================================
...
-- ============================================================================
-- 5. INDEX POUR TRACKING POINTS (OPTIMISATION FUTURE) (protégé)
-- ============================================================================

-- Protection: Vérifier que la table delivery_tracking_points existe
DO $$
BEGIN
...
-- Vue matérialisée pour statistiques de livraisons actives (protégée)
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'deliveries') THEN
