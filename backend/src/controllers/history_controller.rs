...
pub async fn enregistrer_consultation(
    ...
    info!(
        "[enregistrer_consultation] Called for user_id={}, service_id={}",
        user_id, service_id
    );
...
pub async fn get_consultations_utilisateur(
    ...
    info!(
        "[get_consultations_utilisateur] Called for user_id={}",
        user_id
    );
    ...
    //     }
    // }
    Err(crate::core::types::AppError::Internal(String::from(
...
pub async fn get_service_consultation_stats(
    ...
    info!(
        "[get_service_consultation_stats] Called for service_id={}, days={:?}",
        service_id, days
    );
