...
pub mod etablissement_programmes_controller; // ✅ 2026-05-10: Listes scolaires admin (preload + CRUD + config)
pub mod etablissement_team_controller; // ✅ 2026-05-10: Équipe établissement (invitations WhatsApp)
