...
pub fn router_yukpo(state: Arc<AppState>) -> Router<Arc<AppState>> {
    ...
    // ✅ NOUVEAU: Routes pour gestion d'équipe des services (temporairement désactivé - tables manquantes)
    ...
    public_routes
        ...
        // .merge(service_team_routes_merged) // temporairement désactivé - tables manquantes
