...
pub fn bourse_livre_routes(state: Arc<AppState>) -> Router<Arc<AppState>> {
    ...
    let v2_protected_routes = Router::new()
        ...
        .route(
            "/api/bourse-livre/v2/sessions/active",
        ...
        .route(
            "/api/bourse-livre/admin/marketplace-overview",
            get(bourse_livre_v2_controller::get_marketplace_overview),
        )
        .route(
        ...
        // ✅ 2026-05-19 — Liste paquets `constitue` sans coursier (admin/super-lib).
        // Utilisé par dashboard YL + sim 15.
        .route(
    ...
    let etab_admin_routes = Router::new()
        ...
        .route(
            ...
            get(parent_suggestions_controller::get_delivery_info)
                .put(parent_suggestions_controller::put_delivery_info),
        )
