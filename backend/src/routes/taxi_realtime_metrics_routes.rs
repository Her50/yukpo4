...
use crate::services::taxi_realtime_metrics_service::{TaxiRealtimeMetricsService, handle_realtime_metrics_websocket};
...
async fn realtime_metrics_websocket_handler(
    ...
    ws.on_upgrade(move |socket| {
        handle_realtime_metrics_websocket(socket, metrics_service)
    })
}
